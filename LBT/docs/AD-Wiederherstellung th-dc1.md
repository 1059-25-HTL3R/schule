# Technischer Einsatzbericht: Wiederherstellung der AD-Replikation (Equinor)

**Datum:** 04. April 2026
**Systemumgebung:** Windows Server 2022 / Active Directory Forest `corp.equinor.no`
**Durchführender Techniker:** Administrator
...
* **Partition-Fehler (8452):** TH-DC1 befand sich in einem inkonsistenten Zustand ("Naming context is in the process of being removed"), was die Aufnahme neuer Replikationsdaten blockierte.
* **Topologie-Stillstand:** Der KCC (Knowledge Consistency Checker) konnte keine automatischen Verbindungsobjekte erstellen.
...
3. **Konnektivitätstest:**
    ...
    # Prüfung der Namensauflösung nach Trondheim
    nslookup th-dc1.remote.corp.equinor.no
    ```
...
```powershell
# Zusammenfassung des Replikationsstatus (Ziel: überall 0 Fehler)
repadmin /replsummary

# Detailprüfung für den Server in Trondheim
repadmin /showrepl /homeserver:TH-DC1.remote.corp.equinor.no

# Prüfung der Replikations-Warteschlange
repadmin /queue
```
...
* **Bewertung:** Unkritisch. Da die Replikation des SV-RODC von den Oslo-DCs (Hub) fehlerfrei läuft (0 Fails), ist die Datenkonsistenz in Stavanger gewährleistet.
* **Empfehlung:** Replikations-Audits sollten primär von den Hub-DCs (OSLO-DC1/2) aus durchgeführt werden, da diese Sichtverbindung zu allen Standorten haben.
